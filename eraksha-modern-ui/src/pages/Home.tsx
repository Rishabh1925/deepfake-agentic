  ...
  const features = [
    {
      ...
      description: 'Advanced agentic system with 94.9% confidence for reliable deepfake identification',
    },
    {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { step: '2', title: 'AI Analysis', desc: 'Our agentic system analyzes with multiple specialist models' },
              { step: '3', title: 'Get Results', desc: 'Receive detailed analysis with confidence scores and explanations' },
            ].map((item) => (
